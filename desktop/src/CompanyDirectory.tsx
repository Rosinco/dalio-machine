...
export function DirectorySearch({ index, taxonomy, onCompany, onCountry }: { index: BusinessIndex | null; taxonomy: Taxonomy | null; onCompany: (id: string) => void; onCountry: (code: string, name?: string) => void }) {
