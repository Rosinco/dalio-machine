...
- A checked sovereign-refinancing Version 1 denominator now fixes 48 logical streams. Strict Eurostat and ECB adapters make the first 31 harmonized scalar partitions source-ready: 29 annual general-government partitions across DE/FR/IT/ES/SE and two monthly fixed-composition EA21 comparison histories. The other 17 national-native issuer streams are planned but not implemented. This checkpoint has no pipeline, database ingestion, live-database mutation, derived refinancing indicator or risk conclusion; EA21 is a comparator, not a sovereign issuer.
