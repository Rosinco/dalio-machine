...
- **Tests:** 269/269 passing (`pytest`), `ruff check src tests` clean.
...
- **In Progress:** World Fundamentals Map — **MVP shipped (18, P0, P1, 19, P2) + 20 (IMF) + 21 (pressure chains) + P3 (chain flowcharts)**. Next: P4 (bubble), 22 (BIS DSR for Tier-3 → the last 15 empty cells + credit-bust rule on the full basket), 23 (PWT/ECI), 24 (IMTS trade spike), 25 (`jurisdiction_tier` export). Gate 2026-09-14.
...
| P4 | Gapminder bubble with forecast markers, trail, presets |
