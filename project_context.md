...
- **Tests:** 257/257 passing (`pytest`), `ruff check src tests` clean.
...
- **In Progress:** World Fundamentals Map — **MVP shipped (18, P0, P1, 19, P2) + slice 20 (IMF)**. Next: 21 (pressure chains), P3 (chain flowcharts + exposure map), P4 (bubble), 22 (BIS DSR for Tier-3 → the last 15 empty cells). Gate 2026-09-14.
