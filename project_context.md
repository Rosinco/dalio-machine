...
- **Tests:** 266/266 passing (`pytest`), `ruff check src tests` clean.
...
- **In Progress:** World Fundamentals Map — **MVP shipped (18, P0, P1, 19, P2) + 20 (IMF) + 21 (pressure chains)**. Next: P3 (DOT flowcharts, spillover pills, Chains/Exposure map modes), P4 (bubble), 22 (BIS DSR for Tier-3 → the last 15 empty cells + credit-bust rule on the full basket). Gate 2026-09-14.
