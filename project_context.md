...
- **Tests:** 239/239 passing (`pytest`), `ruff check src tests` clean.
...
- **In Progress:** World Fundamentals Map — next: P2 (purpose-view selector + weights + captions, Pareto, coverage confidence) = MVP; then 20 (IMF DataMapper: fills 4 Promises/Production cells per country), 21 (pressure chains), P3/P4. MVP gate 2026-09-14.
