...
- **Tests:** 219/219 passing (`pytest`), `ruff check src tests` clean.
...
- **In Progress:** World Fundamentals Map — next: P1 (fundamentals page: map/leaderboard/table), 19 (remaining 12 indicators incl. WGI + world shares), P2 (views + Pareto). MVP gate 2026-09-14. Known nit: `bind="query-params"` updates the URL on widget interaction but not on the callback's programmatic `session_state` write (map click) — cosmetic, revisit in P1.
